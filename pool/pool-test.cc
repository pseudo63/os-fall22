...
void usage(const char *name) {
    std::cout << "usage: " << name << " shorter --- for a very short subset of tests\n";
    std::cout << "   OR: " << name << " short --- for short subset of tests\n";
...
int main(int argc, char **argv) {
    ...
    if (strcmp(argv[1], "shorter") == 0) {
        test_submit_then_wait_then_submit(1, 1);
